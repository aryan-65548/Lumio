...
export function ResultScreen({
  ...
  return (
    <div>
        ...
        <button
          ...
          className={`
            ...
            ${isGoa
              ...
              : 'bg-[#182029] text-[#F2EFE9] border-[#F2EFE9] hover:bg-[#B22222]'}
          `}
        >
      ...
      <div className="text-center mb-6">
        ...
        <h2
          className={`
            ...
            ${isGoa
              ? 'text-[#083C26] font-serif'
              : 'text-[#F2EFE9] font-cinzel tracking-widest'}
          `}
        >
      ...
      <div
        className="relative w-full aspect-[4/5] border-4 border-[#083C26] rounded-2xl overflow-hidden shadow-xl mb-8 max-w-sm mx-auto
